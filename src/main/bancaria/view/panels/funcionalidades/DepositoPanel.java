...
public class DepositoPanel extends JPanel{
    ...
    private final JPanel containerValor = new JPanel();
    ...
    private final JButton btnEnviar = new JButton("Depositar");

    public DepositoPanel(List<ContaCorrente> dados) {
        this.dados = dados;
        initComponents();
    }
    ...
    private void onClickBtnEnviar() {
        ...
        boolean ret = false;
        try{
             ret = cs.solicitarDesposito(c.get(), valor);
